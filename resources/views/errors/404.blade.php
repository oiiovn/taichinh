...
<div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
    ...
    <div class="mt-4 text-7xl font-bold text-gray-300 dark:text-gray-600">404</div>
    <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-200">Không tìm thấy</h1>
    <p class="mt-2 text-gray-600 dark:text-gray-400 max-w-md">
        Trang hoặc tài nguyên bạn truy cập không tồn tại hoặc đã bị di chuyển.
    </p>
