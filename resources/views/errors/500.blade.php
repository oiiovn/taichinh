...
<div class="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
    ...
    <div class="mt-4 text-7xl font-bold text-gray-300 dark:text-gray-600">500</div>
    <h1 class="mt-4 text-xl font-semibold text-gray-800 dark:text-gray-200">Lỗi máy chủ</h1>
    <p class="mt-2 text-gray-600 dark:text-gray-400 max-w-md">
        Đã xảy ra lỗi. Vui lòng thử lại sau hoặc liên hệ quản trị viên nếu sự cố tiếp diễn.
    </p>
