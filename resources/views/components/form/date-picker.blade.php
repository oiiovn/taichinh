        ...
        this.$nextTick(() => {
            this.flatpickrInstance = flatpickr(this.$refs.dateInput, {
                ...
                onReady: (selectedDates, dateStr, instance) => {
                    if (instance.calendarContainer) instance.calendarContainer.style.zIndex = '2147483647';
                },
                onOpen: (selectedDates, dateStr, instance) => {
                    if (instance && instance.calendarContainer) instance.calendarContainer.style.zIndex = '2147483647';
                },
