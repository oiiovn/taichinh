                ...
                <div class="border-t border-gray-200 pt-4 dark:border-gray-700">
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center gap-2">
                            ...
                            <input type="checkbox" name="can_create_food_buff_order" value="1" {{ old('can_create_food_buff_order') ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
                        ...
                        <label class="flex cursor-pointer items-center gap-2">
                            ...
                            <input type="checkbox" name="can_record_food_salary_payment" value="1" {{ old('can_record_food_salary_payment') ? 'checked' : '' }} class="h-4 w-4 rounded border-gray-300 text-brand-500 focus:ring-brand-500">
