...
<div class="space-y-4">
    ...
    <form method="POST" action="{{ route('food.reviews.import-text') }}" class="rounded-xl border border-blue-200 bg-blue-50/60 p-4 dark:border-blue-700 dark:bg-blue-900/20">
        ...
        <p class="mb-3 text-xs text-gray-600 dark:text-gray-400">Hệ thống tách theo mã <span class="font-mono">#xxxx-xxxx</span> và chống trùng theo chính mã đó. Mọi đánh giá nhập lên đều được ghi nhận <strong>5 sao</strong>.</p>
