{{-- Level 3 – Internalized: giảm coaching, phân tích sâu, tự điều chỉnh --}}
@php
    $radar = $behaviorRadar ?? [];
...
@endphp
<div class="tong-quan-analytic w-full max-w-[1000px] space-y-6">
    ...
    <header>
        ...
        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Phân tích và chỉ số — bạn tự điều chỉnh.</p>
    </header>
    <section class="grid grid-cols-2 gap-3 sm:grid-cols-4">
        @if($trust !== null)<div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800/60"><p class="text-xs uppercase text-gray-400 dark:text-gray-500">Trust</p><p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $trust }}%</p></div>@endif
        ...
        @if($proj60 !== null)<div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800/60"><p class="text-xs uppercase text-gray-400 dark:text-gray-500">60d</p><p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $proj60 }}%</p></div>@endif
    ...
    <section class="grid gap-6 sm:grid-cols-2">
        <div class="rounded-xl border border-gray-200 bg-gray-50/50 p-5 dark:border-gray-700 dark:bg-gray-800/30">
