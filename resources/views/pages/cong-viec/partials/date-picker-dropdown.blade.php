...
<div class="relative" x-data="{
    ...
    applySmartParsed(d) { if (!d) return; if (d.dueDate) { const p = d.dueDate.split('-').map(Number); if (p.length >= 3) { this.selectedDate = { d: p[2], m: p[1] - 1, y: p[0] }; this.calendarYear = p[0]; this.calendarMonth = p[1] - 1; this.updateGrid(); if (this.$refs.taskDueDate) this.$refs.taskDueDate.value = d.dueDate; } } if (d.dueTime) this.setTime(d.dueTime); }
