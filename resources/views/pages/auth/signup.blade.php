                ...
                <div class="mx-auto w-full max-w-md pt-5 sm:py-10">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <div class="flex gap-2">
                            <a href="{{ route('signin') }}" class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">Đăng nhập</a>
                            <span class="inline-flex items-center rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white">Đăng ký</span>
                        </div>
                    </div>
                </div>
                    ...
                    <div>
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                        Họ tên<span class="text-error-500">*</span>
                                    </label>
                                    <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Nhập họ tên" required
                                ...
                                <div>
                                    ...
                                    <div x-data="{ showPassword: false }" class="relative">
                                        <input :type="showPassword ? 'text' : 'password'" name="password" placeholder="Nhập mật khẩu" required
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                Đã có tài khoản?
                                <a href="{{ route('signin') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Đăng nhập</a>
                            </p>
                        </div>
                    </div>
                </div>
