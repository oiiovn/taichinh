                ...
                <div class="mx-auto w-full max-w-md pt-10">
                    <div class="flex items-center justify-between gap-4">
                        ...
                        <div class="flex gap-2">
                            <span class="inline-flex items-center rounded-lg bg-brand-500 px-4 py-2 text-sm font-medium text-white">Đăng nhập</span>
                            <a href="{{ route('signup') }}" class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 transition hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700">Đăng ký</a>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                    Chưa có tài khoản?
                                    <a href="{{ route('signup') }}" class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Đăng ký</a>
                                </p>
                            </div>
                        </div>
                    </div>
