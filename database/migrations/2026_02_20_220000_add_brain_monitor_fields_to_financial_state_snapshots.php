...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('financial_state_snapshots') || Schema::hasColumn('financial_state_snapshots', 'brain_mode_key')) {
            return;
        }
        Schema::table('financial_state_snapshots', function (Blueprint $table) {
            $table->string('brain_mode_key', 64)->nullable()->comment('Brain mode tại thời điểm snapshot (cho monitor)');
